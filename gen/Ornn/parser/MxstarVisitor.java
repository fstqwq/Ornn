...
public interface MxstarVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitTypeBool(MxstarParser.TypeBoolContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitTypeInt(MxstarParser.TypeIntContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitTypeString(MxstarParser.TypeStringContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitTypeIdentifier(MxstarParser.TypeIdentifierContext ctx);
	/**
