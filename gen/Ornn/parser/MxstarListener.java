...
public interface MxstarListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterTypeBool(MxstarParser.TypeBoolContext ctx);
	/**
	 * Exit a parse tree produced by the {@code typeBool}
	 * labeled alternative in {@link MxstarParser#nonarrayType}.
	 * @param ctx the parse tree
	 */
	void exitTypeBool(MxstarParser.TypeBoolContext ctx);
	/**
	 * Enter a parse tree produced by the {@code typeInt}
	 * labeled alternative in {@link MxstarParser#nonarrayType}.
	 * @param ctx the parse tree
	 */
	void enterTypeInt(MxstarParser.TypeIntContext ctx);
	/**
	 * Exit a parse tree produced by the {@code typeInt}
	 * labeled alternative in {@link MxstarParser#nonarrayType}.
	 * @param ctx the parse tree
	 */
	void exitTypeInt(MxstarParser.TypeIntContext ctx);
	/**
	 * Enter a parse tree produced by the {@code typeString}
	 * labeled alternative in {@link MxstarParser#nonarrayType}.
	 * @param ctx the parse tree
	 */
	void enterTypeString(MxstarParser.TypeStringContext ctx);
	/**
	 * Exit a parse tree produced by the {@code typeString}
	 * labeled alternative in {@link MxstarParser#nonarrayType}.
	 * @param ctx the parse tree
	 */
	void exitTypeString(MxstarParser.TypeStringContext ctx);
	/**
	 * Enter a parse tree produced by the {@code typeIdentifier}
	 * labeled alternative in {@link MxstarParser#nonarrayType}.
	 * @param ctx the parse tree
	 */
	void enterTypeIdentifier(MxstarParser.TypeIdentifierContext ctx);
	/**
	 * Exit a parse tree produced by the {@code typeIdentifier}
	 * labeled alternative in {@link MxstarParser#nonarrayType}.
	 * @param ctx the parse tree
	 */
	void exitTypeIdentifier(MxstarParser.TypeIdentifierContext ctx);
	/**
