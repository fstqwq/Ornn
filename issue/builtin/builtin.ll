...
define dso_local void @printInt(i32 %0) local_unnamed_addr #0 {
  %2 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32 %0)
  ret void
}

; Function Attrs: nofree nounwind uwtable
define dso_local void @printlnInt(i32 %0) local_unnamed_addr #0 {
  %2 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i64 0, i64 0), i32 %0)
  ret void
}

; Function Attrs: nofree nounwind uwtable
define dso_local i8* @getString() local_unnamed_addr #0 {
  %1 = tail call noalias dereferenceable_or_null(1024) i8* @malloc(i64 1024) #8
...
define dso_local noalias i8* @toString(i32 %0) local_unnamed_addr #0 {
  %2 = tail call noalias dereferenceable_or_null(12) i8* @malloc(i64 12) #8
  %3 = tail call i32 (i8*, i8*, ...) @sprintf(i8* nonnull dereferenceable(1) %2, i8* nonnull dereferenceable(1) getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32 %0) #8
  ret i8* %2
}
...
define dso_local i32 @string_parseInt(i8* nocapture readonly %0) local_unnamed_addr #3 {
  ...
  %4 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %0, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i32* nonnull %2) #8
...
define dso_local i8* @string_add(i8* nocapture readonly %0, i8* nocapture readonly %1) local_unnamed_addr #3 {
  ...
  %12 = tail call i8* @strcat(i8* nonnull dereferenceable(1) %9, i8* nonnull dereferenceable(1) %1) #8
  ret i8* %9
}
...
define dso_local zeroext i1 @string_eq(i8* nocapture readonly %0, i8* nocapture readonly %1) local_unnamed_addr #5 {
  %3 = tail call i32 @strcmp(i8* nonnull dereferenceable(1) %0, i8* nonnull dereferenceable(1) %1) #9
  %4 = icmp eq i32 %3, 0
  ret i1 %4
}
